...
export const iconDefs = {
  ...
  /** settings — gear cog (Material Icons filled, 24px) */
  SettingsIcon: {
    viewBox: '0 0 24 24',
    paths: [
      {
  ...
  /** person — silhouette for baby profile (Material Icons "person") */
  PersonIcon: {
    viewBox: '0 0 24 24',
    paths: [
      {
  ...
  /** Filter / tune — three horizontal sliders (Material Icons "tune") */
  FilterIcon: {
    viewBox: '0 0 24 24',
    paths: [
      {
